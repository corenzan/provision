...
default_ssh_port=822
read -p "    - Enter your SSH Port (default:$default_ssh_port):" ssh_port=${ssh_port:-$default_ssh_port}
export ssh_port=${ssh_port:-$default_ssh_port}
echo ""
...
allowed_tcp_ports="80 443 $ssh_port"
